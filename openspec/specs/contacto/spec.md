...
La página `contacto.html`: la vía por la que un visitante se pone en contacto con Oscar. En esta fase de la web es una sola — el correo — y la página explica qué pasa después de escribir.
